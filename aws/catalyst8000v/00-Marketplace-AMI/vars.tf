variable "aws_branch1_region" {    
    default = "us-east-1"             # if you change the default region, please also change AMI IDs below
}
...
variable "aws_ami_id_branch1_r1" {
  default = "ami-0d60a2507ffd2e6f0"   # Cisco-CSR-SDWAN-17.3.2 Marketplace AMI for this region. Please change the AMI if you want to use a different region!
}
